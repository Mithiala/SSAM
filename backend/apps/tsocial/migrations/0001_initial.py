    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('td_familiar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='td_familiar', to='tsocial.paciente', verbose_name='Tabajo Diario')),
                ('td_paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='td_paciente', to='tsocial.paciente', verbose_name='Tabajo Diario')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enc_paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='encuesta_paciente', to='tsocial.paciente', verbose_name='Encuesta Paciente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disc_paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='disc_paciente', to='tsocial.paciente', verbose_name='Discapacidad')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cp_familiar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cp_familiar', to='tsocial.paciente', verbose_name='Control Pase')),
                ('cp_paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cp_paciente', to='tsocial.paciente', verbose_name='Control Pase')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cf_paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cf_paciente', to='tsocial.paciente', verbose_name='ComposiciónF Paciente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('at_paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='at_paciente', to='tsocial.paciente', verbose_name='Ayuda Técnica')),
            ],
            options={
